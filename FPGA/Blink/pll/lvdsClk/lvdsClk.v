...
`timescale 1 ns / 1 ps
module lvdsClk (CLKI, CLKFB, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire CLKFB;
    output wire CLKOP;
    ...
    EHXPLLL PLLInst_0 (.CLKI(buf_CLKI), .CLKFB(CLKFB), .PHASESEL1(scuba_vlo), 
        ...
        .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             /* synthesis FREQUENCY_PIN_CLKOP="336.000000" */
    ...
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 336.000000
